...
The next section contains sample settings.  Some of these are covered [here](/docs-tech/tooling/ssgs/mkdocs/add-ons).
...
### Extending and Overriding Theme Styling
...
Add MkDocs Schema to VSCode.  See [VSCode YAML Extension](../../../tooling/ides/vscode/extensions)
