...
Theme colors can be overriden in [User Settings](../vscode/settings.md).  See [VS Code Workbench Color List](./workbench.colorCustomizations) for available customizations.
