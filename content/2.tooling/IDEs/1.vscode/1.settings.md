...
Theme colors can be overridden in [User Settings](settings).  See [VS Code Workbench Color List](../vscode/workbench-colorCustomizations) for available customizations.
...
See [VS Code Workbench Color List](../vscode/workbench-colorCustomizations) for available customizations.
