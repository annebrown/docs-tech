...
The next section contains sample settings.  Some of these are covered [here](../mkdocs/add-ons).
...
Add MkDocs Schema to VSCode.  See [VSCode YAML Extension](../../../Tooling/IDEs/vscode/extensions#yaml)
